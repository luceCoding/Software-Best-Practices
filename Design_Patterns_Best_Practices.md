...
- Create a language that other engineers can easily relate to.
  - By having design patterns nomenclature, engineers can communicate effectively between each other on a higher level abstraction without discussing implementation details.
- Allow code reuse.
